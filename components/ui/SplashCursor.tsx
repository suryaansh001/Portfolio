...
export default function SplashCursor({
  ...
  BACK_COLOR = { r: 0.12, g: 0.06, b: 0.2 }, // Dark purple background
  TRANSPARENT = true
}: SplashCursorProps) {
  ...
  useEffect(() => {
    ...
    function clickSplat(pointer: Pointer) {
      // Define your custom color palette for click splats
      const colorPalette = [
        // Purple shades
        { r: 168/255, g: 85/255, b: 247/255 },   // #a855f7
        { r: 139/255, g: 92/255, b: 246/255 },   // #8b5cf6
        { r: 124/255, g: 58/255, b: 237/255 },   // #7c3aed
        { r: 147/255, g: 51/255, b: 234/255 },   // #9333ea
        // Pink shades
        { r: 236/255, g: 72/255, b: 153/255 },   // #ec4899
        { r: 219/255, g: 39/255, b: 119/255 },   // #db2777
        { r: 190/255, g: 24/255, b: 93/255 },    // #be185d
        // Blue accents
        { r: 59/255, g: 130/255, b: 246/255 },   // #3b82f6
        { r: 37/255, g: 99/255, b: 235/255 },    // #2563eb
        { r: 29/255, g: 78/255, b: 216/255 },    // #1d4ed8
      ];
      
      // Randomly select a color from the palette
      const selectedColor = colorPalette[Math.floor(Math.random() * colorPalette.length)];
      
      // Apply higher intensity for click effects
      const color = {
        r: selectedColor.r * 8,  // Reduced from 15
        g: selectedColor.g * 8,  // Reduced from 15
        b: selectedColor.b * 8,  // Reduced from 15
      };
    ...
    function generateColor(): ColorRGB {
      ...
      const intensity = 0.4 + Math.random() * 0.3; // Random intensity between 0.4 and 0.7 (reduced from 0.8-1.2)
